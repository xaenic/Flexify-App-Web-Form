            ...
            <div class="col-span-8 h-full grid grid-cols-1 md:grid-cols-4 relative overflow-hidden">
                ...
                <div class="md:pt-10 flex-col flex items-center col-span-2 md:mt-20">
                    ...
                    <div class="md:mt-10 w-full flex flex-col gap-4 p-2">
                        <div>
                            <div class="bg-zinc-300 p-4 rounded-lg text-black flex gap-3 border border-gray-300">
                                <img src="Images/user.svg" />
                                <asp:TextBox ID="txtEmail" runat="server" CssClass="w-full bg-transparent outline-none border-none" placeholder="Email or Username" required="required"></asp:TextBox>
                            </div>
                        ...
                        <div>
                            <div class="bg-zinc-300 p-4 rounded-lg text-black flex gap-3 border border-gray-300">
                                ...
                                <asp:TextBox ID="txtPassword" runat="server" TextMode="Password" CssClass="w-full bg-transparent outline-none border-none" placeholder="Password" required="required"></asp:TextBox>
                            </div>
                        </div>
                        <div>
                        ...
                        <div>
                            <div class="bg-gradient-to-r from-[#DB4C40] to-[#090C02] p-4 rounded-lg text-white font-bold">
                                <asp:Button ID="btnLogin" runat="server" Text="Login" CssClass="cursor-pointer w-full bg-transparent outline-none border-none" OnClick="btnLogin_Click" />
                            </div>
                        </div>
                        <div>
                            <asp:Label ID="lblErrorMessage" runat="server" CssClass="text-red-600" Visible="false"></asp:Label>
                        </div>
                    </div>
